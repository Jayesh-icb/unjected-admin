...
const Dashboardview = ({ user, signOut }) => {
    ...
    <div className="">
      <div className="flex items-center justify-between h-[70px] shadow-lg px-[25px] ">
        <div className="flex items-center rounded-[5px]">
          ...
          {/* <h1 class="font-medium text-blue-500 text-opacity-75 text-3xl">
            Unjected
          </h1> */}
          <div className=" w-[180px] cursor-pointer flex items-center justify-center relative z-40">
